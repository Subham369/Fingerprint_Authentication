...
import com.example.fingerprintauthentication.Helper.GraphicOverlay;
import com.example.fingerprintauthentication.Helper.RectOverlay;
...
public class Attendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detect_face_btn=findViewById(R.id.detect_face_btn);
    ...
    private void processFaceDetection(Bitmap bitmap) {
        ...
        firebaseVisionFaceDetector.detectInImage(firebaseVisionImage).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Attendance.this, "Error :"+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
